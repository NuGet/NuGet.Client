param (
    ...
    [string]$PFXPath,
    [switch]$Stable,
    [Parameter(Mandatory=$True)][ValidateSet("NuGet.PackageManagement", "NuGet.ProjectManagement", "NuGet.TestUtility", "NuGet.PackageManagement.UI", "NuGet.PackageManagement.PowerShellCmdlets")][string]$Id,
    [switch]$NoLock
)
