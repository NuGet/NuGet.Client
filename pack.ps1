param (
    ...
    [string]$PFXPath,
    [switch]$Stable,
    [Parameter(Mandatory=$True)][ValidateSet("NuGet.PackageManagement", "NuGet.TestUtility", "NuGet.PackageManagement.UI", "NuGet.PackageManagement.PowerShellCmdlets")][string]$Id,
    [switch]$NoLock
)
