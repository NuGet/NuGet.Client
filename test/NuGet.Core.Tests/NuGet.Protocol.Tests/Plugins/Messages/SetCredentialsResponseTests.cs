...
{
    public class SetCredentialsResponseTests
    {
        [Fact]
        public void Constructor_ThrowsForUndefinedResponseCode()
        {
            var exception = Assert.Throws<ArgumentException>(
                () => new SetCredentialsResponse((MessageResponseCode)int.MinValue));
        ...
        {
            var response = JsonSerializer.Deserialize(json, PluginJsonContext.Default.SetCredentialsResponse)!;
        ...
        public void JsonDeserialization_ThrowsForInvalidResponseCode(string json)
        {
            Assert.Throws<JsonException>(
                () => JsonSerializer.Deserialize(json, PluginJsonContext.Default.SetCredentialsResponse));
        }
    }
}
