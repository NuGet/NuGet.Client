...
namespace NuGet.Protocol.Plugins.Tests
{
    public class InitializeResponseTests
    {
        ...
        {
            var response = JsonSerializer.Deserialize(json, PluginJsonContext.Default.InitializeResponse)!;
        ...
        public void JsonDeserialization_ThrowsForInvalidResponseCode(string json)
        {
            Assert.Throws<JsonException>(
                () => JsonSerializer.Deserialize(json, PluginJsonContext.Default.InitializeResponse));
        }
    }
}
