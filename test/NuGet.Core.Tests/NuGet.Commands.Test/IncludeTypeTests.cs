...
namespace NuGet.Commands.Test
{
    ...
    public class IncludeTypeTests
    {
            ...
            string configJson2)
        {
            ...
            var spec1 = JsonPackageSpecReader.GetPackageSpec(configJson1, "TestProject1", specPath1).WithProjectJsonTestRestoreMetadata();
            ...
            var spec2 = JsonPackageSpecReader.GetPackageSpec(configJson2, "TestProject2", specPath2).WithProjectJsonTestRestoreMetadata();
            ...
            string configJson3)
        {
            ...
            var spec3 = JsonPackageSpecReader.GetPackageSpec(configJson3, "TestProject3", specPath3).WithProjectJsonTestRestoreMetadata();
            ...
            string configJson)
        {
            ...
            var spec = JsonPackageSpecReader.GetPackageSpec(configJson, "TestProject", specPath).WithProjectJsonTestRestoreMetadata();
