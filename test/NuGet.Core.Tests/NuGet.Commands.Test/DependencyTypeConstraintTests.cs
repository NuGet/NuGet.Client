    ...
    public class DependencyTypeConstraintTests
    {
        ...
        public async Task DependencyTypeConstraint_DefaultBehaviorWithNoTargetAsync()
        {
            ...
            using (var workingDir = TestDirectory.Create())
            {
                ...
                var spec1 = JsonPackageSpecReader.GetPackageSpec(project1Json, "project1", specPath1).WithProjectJsonTestRestoreMetadata();
                var spec2 = JsonPackageSpecReader.GetPackageSpec(packageAProjectJson, "packageA", specPath2).WithProjectJsonTestRestoreMetadata();
                var spec3 = JsonPackageSpecReader.GetPackageSpec(packageAExternalProjectJson, "packageA", specPath3).WithProjectJsonTestRestoreMetadata();
