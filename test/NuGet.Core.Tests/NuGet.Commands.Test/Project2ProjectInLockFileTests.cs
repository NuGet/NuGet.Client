    ...
    public class Project2ProjectTests
    {
        ...
        public async Task Project2ProjectInLockFile_VerifySnapshotVersions()
        {
            ...
            using (var workingDir = TestDirectory.Create())
            {
                ...
                var spec1 = JsonPackageSpecReader.GetPackageSpec(projectJson, "project1", specPath1).WithProjectJsonTestRestoreMetadata();
                var spec2 = JsonPackageSpecReader.GetPackageSpec(project2Json, "project2", specPath2).WithProjectJsonTestRestoreMetadata();
                var spec3 = JsonPackageSpecReader.GetPackageSpec(project3Json, "project3", specPath3).WithProjectJsonTestRestoreMetadata();
        ...
        public async Task Project2ProjectInLockFile_PackageReferenceConflict()
        {
            ...
            using (var workingDir = TestDirectory.Create())
            {
                ...
                var specPath1 = Path.Combine(project1.FullName, "project.json");
                var specPath2 = Path.Combine(project2.FullName, "project.json");
                var spec1 = JsonPackageSpecReader.GetPackageSpec(project1Json, "project1", specPath1).WithProjectJsonTestRestoreMetadata();
                var spec2 = JsonPackageSpecReader.GetPackageSpec(project2Json, "project2", specPath2).WithProjectJsonTestRestoreMetadata();
        ...
        public async Task Project2ProjectInLockFile_VerifyProjectsUnderProjectFileDependencyGroups_External()
        {
            ...
            using (var workingDir = TestDirectory.Create())
            {
                ...
                var specPath3 = Path.Combine(project3.FullName, "project.json");
                var spec1 = JsonPackageSpecReader.GetPackageSpec(projectJson, "project1", specPath1).WithProjectJsonTestRestoreMetadata();
                var spec2 = JsonPackageSpecReader.GetPackageSpec(projectJson, "project2", specPath2).WithProjectJsonTestRestoreMetadata();
                var spec3 = JsonPackageSpecReader.GetPackageSpec(projectJson, "project3", specPath3).WithProjectJsonTestRestoreMetadata();
