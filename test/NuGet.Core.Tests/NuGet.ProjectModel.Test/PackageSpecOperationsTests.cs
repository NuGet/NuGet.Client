...
namespace NuGet.ProjectModel.Test
{
    ...
    {
        [Fact]
        public void AddOrUpdateDependency_PackageDependency_WithNonPackageReferenceProjectStyle_AddsNewPackageDependencyToGenericDependencies()
        {
            // Arrange
        ...
        [Fact]
        public void AddOrUpdateDependency_PackageDependency_WithPackageReferenceProjectStyle_AddsNewPackageDependencyToAllFrameworksIndividually()
        {
            // Arrange
            var spec = new PackageSpec(new[]
            {
        ...
        [Fact]
        public void AddOrUpdateDependency_PackageDependency_WithExistingGenericPackageDependencies_UpdatesOnlyFrameworksWherePackageExists()
        {
        ...
        [Fact]
        public void AddOrUpdateDependency_PackageDependency_WithExistingPackageDependencies_UpdatesOnlyFrameworksWherePackageDependencyExists()
        {
            var dependency = new LibraryDependency
            {
                LibraryRange = new LibraryRange("NuGet.Versioning", new VersionRange(new NuGetVersion("1.0.0")), LibraryDependencyTarget.Package),
        ...
        [Fact]
        public void AddOrUpdateDependency_PackageDependency_WithExistingPackages_UpdatesAllPackageDependency()
        {
            // Arrange
