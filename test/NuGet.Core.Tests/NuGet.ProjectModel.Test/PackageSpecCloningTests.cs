...
namespace NuGet.ProjectModel.Test
{
    public class PackageSpecCloningTests
    {
        ...
        internal static TargetFrameworkInformation CreateTargetFrameworkInformation(string tfm = "net461")
        {
            ...
            originalTargetFrameworkInformation.AddCentralPackageVersionInformation(new List<CentralVersionDependency>(){new CentralVersionDependency("CVD", VersionRange.Parse("1.0.0"))});
