...
namespace NuGet.ProjectModel.Test
{
    public class Utf8JsonStreamTests
    {
        ...
        [InlineData(false)]
        [InlineData(true)]
        public void Create_WithChunkedInputAndSingleByteOutput_ProducesUtf8(bool includeBom)
        {
            const string expected = "ASCII \u00E9 \U0001F600 end";
            Encoding sourceEncoding = new UTF8Encoding(encoderShouldEmitUTF8Identifier: includeBom);
