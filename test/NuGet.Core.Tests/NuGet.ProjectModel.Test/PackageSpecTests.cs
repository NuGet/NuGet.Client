...
#pragma warning restore CS0612 // Type or member is obsolete
        ...
        internal static TargetFrameworkInformation CreateTargetFrameworkInformation(string tfm = "net461", string alias = null)
        {
            ...
            var originalTargetFrameworkInformation = new TargetFrameworkInformation()
            {
                ...
                CentralPackageVersions = TargetFrameworkInformation.CreateCentralPackageVersions([new KeyValuePair<string, CentralPackageVersion>("CVD", new CentralPackageVersion("CVD", VersionRange.Parse("1.0.0")))]),
