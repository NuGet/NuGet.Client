...
namespace NuGet.Configuration.Test
{
    public class PackageSourceNamespacesItemTests
    {
        ...
        {
            var left = new PackageSourceNamespacesItem("name", new List<NamespaceItem>() { new NamespaceItem("stuff") });
            var right = new PackageSourceNamespacesItem("name", new List<NamespaceItem>() { new NamespaceItem("stuff") });
        ...
        {
            var left = new PackageSourceNamespacesItem("name2", new List<NamespaceItem>() { new NamespaceItem("stuff"), new NamespaceItem("stuff2") });
            var right = new PackageSourceNamespacesItem("name", new List<NamespaceItem>() { new NamespaceItem("stuff"), new NamespaceItem("stuff2") });
        ...
        {
            var left = new PackageSourceNamespacesItem("name", new List<NamespaceItem>() { new NamespaceItem("stuff"), new NamespaceItem("stuff2") });
            var right = new PackageSourceNamespacesItem("name", new List<NamespaceItem>() { new NamespaceItem("stuff"), new NamespaceItem("stuff3") });
            left.Equals(right).Should().BeTrue();
        }
        ...
        {
            var original = new PackageSourceNamespacesItem("name", new List<NamespaceItem>() { new NamespaceItem("stuff"), new NamespaceItem("stuff2") });
        ...
        {
            var original = new PackageSourceNamespacesItem("name", new List<NamespaceItem>() { new NamespaceItem("stuff"), new NamespaceItem("stuff2") });
            var clone = original.Clone() as PackageSourceNamespacesItem;
...
<configuration>
    <packageNamespaces>
        <packageSource key=""nuget.org"">
            ...
            var clone = packageSourceNamespacesItem.Clone() as PackageSourceNamespacesItem;
