...
namespace NuGet.Test
{
    public class CompatibilityTests
    {
        ...
        // xamarinmacnet -> net, xamarinmac, netstandard, dotnet
        [InlineData("xamarinmacnet", "net461", false)]
        [InlineData("xamarinmacnet", "net46", false)]
        [InlineData("xamarinmacnet", "net452", false)]
        [InlineData("xamarinmacnet", "net451", false)]
        [InlineData("xamarinmacnet", "net45", true)]
        [InlineData("xamarinmacnet", "net4", true)]
        [InlineData("xamarinmacnet", "net2", true)]
        [InlineData("xamarinmacnet", "xamarinmacnet45", false)]
        [InlineData("xamarinmacnet", "xamarinmac3", false)]
        [InlineData("xamarinmacnet", "xamarinmac2", true)]
        [InlineData("xamarinmacnet", "xamarinmac1", true)]
        [InlineData("xamarinmacnet", "xamarinmac", true)]
        [InlineData("xamarinmacnet", "netstandard2.1", false)]
        [InlineData("xamarinmacnet", "netstandard2.0", true)]
        [InlineData("xamarinmacnet", "netstandard1.7", true)]
        [InlineData("xamarinmacnet", "netstandard1.6", true)]
        [InlineData("xamarinmacnet", "netstandard1.5", true)]
        [InlineData("xamarinmacnet", "netstandard1.4", true)]
        [InlineData("xamarinmacnet", "netstandard1.3", true)]
        [InlineData("xamarinmacnet", "netstandard1.2", true)]
        [InlineData("xamarinmacnet", "netstandard1.1", true)]
        [InlineData("xamarinmacnet", "netstandard1.0", true)]
        [InlineData("xamarinmacnet", "dotnet5.7", false)]
        [InlineData("xamarinmacnet", "dotnet5.6", true)]
        [InlineData("xamarinmacnet", "dotnet5.5", true)]
        [InlineData("xamarinmacnet", "dotnet5.4", true)]
        [InlineData("xamarinmacnet", "dotnet5.3", true)]
        [InlineData("xamarinmacnet", "dotnet5.2", true)]
        [InlineData("xamarinmacnet", "dotnet5.1", true)]
        [InlineData("xamarinmacnet", "portable-win8+net45", true)]
        [InlineData("xamarinmacnet", "dnx45", false)]
        [InlineData("xamarinmacnet", "netstandardapp10", false)]
        [InlineData("xamarinmacnet", "netcoreapp10", false)]
        [InlineData("xamarinmacnet", "win8", false)]
        [InlineData("xamarinmacnet", "uap10.0", false)]
        [InlineData("xamarinmacnet", "sl7", false)]
        [InlineData("xamarinmacnet", "wpa", false)]
        [InlineData("xamarinmacnet45", "netstandard1.6", true)]
        [InlineData("xamarinmacnet45", "net461", false)]
