...
namespace NuGet.Test
{
    public class CompatibilityTests
    {
        ...
        [InlineData("netcoreapp9.0", "netstandard1.5", true)]
        [InlineData("netcoreapp1.3", "netstandard2.1", false)]
        [InlineData("netcoreapp1.3", "netstandard2.0", true)]
        [InlineData("netcoreapp1.2", "netstandard2.1", false)]
        [InlineData("netcoreapp1.2", "netstandard2.0", true)]
