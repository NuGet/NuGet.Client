...
namespace NuGet.Test
{
    public class FrameworkReducerTests
    {
        ...
        // XamarinMacNet
        [InlineData("xamarinmacnet", "xamarinmacnet,xamarinmac2,net45,netstandard1.0,portable-net45+win8,win8", "xamarinmacnet")]
        [InlineData("xamarinmacnet", "xamarinmacnet45,xamarinmacnet,xamarinmac2,net45,netstandard1.0,portable-net45+win8,win8", "xamarinmacnet")]
        ...
        [InlineData("xamarinmacnet", "xamarinmac2,net45,netstandard1.0,portable-net45+win8,win8", "xamarinmac2")]
        [InlineData("xamarinmacnet", "xamarinmac1,net45,netstandard1.0,portable-net45+win8,win8", "xamarinmac1")]
        [InlineData("xamarinmacnet", "net45,netstandard1.0,portable-net45+win8,win8", "net45")]
        [InlineData("xamarinmacnet", "net40,netstandard1.0,portable-net45+win8,win8", "net40")]
        [InlineData("xamarinmacnet", "portable-net45+win8,win8", "portable-net45+win8")]
        [InlineData("xamarinmacnet", "portable-net40+win8,win8", "portable-net40+win8")]
        [InlineData("xamarinmacnet", "netstandard1.5,win8", "netstandard1.5")]
        [InlineData("xamarinmacnet", "netstandard1.4,win8", "netstandard1.4")]
        [InlineData("xamarinmacnet", "netstandard1.7,net46,win8", "netstandard1.7")]
        [InlineData("xamarinmacnet", "netstandard2.0,net46,win8", "netstandard2.0")]
        [InlineData("xamarinmacnet", "netstandard2.1,net46,win8", null)]
        [InlineData("xamarinmacnet", "net46,win8", null)]
        [InlineData("xamarinmacnet", "win8", null)]
        // Additional tests
