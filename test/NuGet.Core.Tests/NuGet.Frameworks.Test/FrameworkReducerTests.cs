...
namespace NuGet.Test
{
    public class FrameworkReducerTests
    {
        ...
        [InlineData("uap10.0", "dotnet5.5,dotnet5.4,portable-win81+net45", "dotnet5.5")]
        ...
        [InlineData("uap10.0", "uap10.1,dotnet5.6,dotnet5.5.0.1,dotnet6.0,dnxcore50,native", null)]
