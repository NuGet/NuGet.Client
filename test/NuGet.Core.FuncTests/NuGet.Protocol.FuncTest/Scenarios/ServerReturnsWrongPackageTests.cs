...
{
    public class ServerReturnsWrongPackageTests : IClassFixture<ServerReturnsWrongPackageTests.Fixture>
    {
        public ServerReturnsWrongPackageTests(Fixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public async Task FindPackageById_FailsToDownload(FeedType feedType, bool noHttpCache)
        {
            ...
            switch (feedType)
            {
                ...
                case FeedType.HttpV2:
                    url = V2Url;
                    break;
                case FeedType.FileSystemPackagesConfig:
                    url = _fixture.LocalPackagesConfigPath;
                    break;
                case FeedType.FileSystemV3:
                    url = _fixture.LocalV3Path;
                    break;
                case FeedType.FileSystemV2:
                    url = _fixture.LocalV2Path;
                    break;
                default:
                    throw new ArgumentException(nameof(feedType));
            }
