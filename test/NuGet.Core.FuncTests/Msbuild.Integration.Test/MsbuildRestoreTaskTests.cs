...
<configuration>
    ...
    <packageNamespaces>
        ...
        [PlatformFact(Platform.Windows)]
        public async Task MsbuildRestore__NoPackageNamespacesection_NoSourceRelatedLogMessage()
        {
            // Arrange
            using (var pathContext = new SimpleTestPathContext())
            {
    ...
    <packageNamespaces>
        ...
        <packageSource key=""SharedRepository"">
            <namespace id=""Contoso.MVC.ASP"" />   <!-- Longer prefix prevails over Contoso.MVC.* -->
                ...
                // Act
                var result = _msbuildFixture.RunMsBuild(pathContext.WorkingDirectory, $"/t:restore -v:d {pathContext.SolutionRoot} /p:RestorePackagesConfig=true -property:RestoreSources='..\\Mypackages3'", ignoreExitCode: true);
