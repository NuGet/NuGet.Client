...
namespace NuGet.Signing.CrossFramework.Test
{
    public class CrossVerifyTestFixture : IDisposable
    {
        ...
        //In netfx code path, the SDK version and TFM could not be detected automatically, so we manually specified according to the sdk version we're testing against.
