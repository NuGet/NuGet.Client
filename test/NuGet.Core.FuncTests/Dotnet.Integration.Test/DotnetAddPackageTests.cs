            ...
            using (SimpleTestPathContext pathContext = new())
            {
                ...
                if (RuntimeEnvironmentHelper.IsWindows)
                {
                    result.AllOutput.Should()
                        .Contain(
                            NuGet.Packaging.Strings.ChainBuilding_UsingDefaultTrustStore,
                ...
                else
                {
                    result.AllOutput.Should()
                        .ContainAny(
                            new string[] {
                                NuGet.Packaging.Strings.ChainBuilding_UsingFallbackCertificateBundle,
                                NuGet.Packaging.Strings.ChainBuilding_UsingSystemCertificateBundle
                            },
                            because: result.AllOutput);
                }
