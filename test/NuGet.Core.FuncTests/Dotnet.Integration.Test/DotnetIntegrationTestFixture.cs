...
namespace Dotnet.Integration.Test
{
    public class DotnetIntegrationTestFixture : IDisposable
    {
        ...
        /// </summary>
        internal void CreateDotnetNewProject(string solutionRoot, string projectName, string args, Action<string> logLine = null)
        {
            args = args.Trim();
        ...
        internal CommandRunnerResult RestoreToolProjectExpectFailure(string workingDirectory, string projectName, string args = "", Action<string> logLine = null)
            => RunDotnetExpectFailure(workingDirectory, $"restore {projectName}.csproj {args}", logLine: logLine);

        internal CommandRunnerResult RestoreToolProjectExpectSuccess(string workingDirectory, string projectName, string args = "", Action<string> logLine = null)
            => RunDotnetExpectSuccess(workingDirectory, $"restore {projectName}.csproj {args}", logLine: logLine);

        internal CommandRunnerResult RestoreProjectExpectFailure(string workingDirectory, string projectName, string args = "", Action<string> logLine = null)
            => RestoreProjectOrSolution(workingDirectory, $"{projectName}.csproj", args, expectSuccess: false, logLine: logLine);

        internal CommandRunnerResult RestoreProjectExpectSuccess(string workingDirectory, string projectName, string args = "", Action<string> logLine = null)
            => RestoreProjectOrSolution(workingDirectory, $"{projectName}.csproj", args, expectSuccess: true, logLine: logLine);

        internal CommandRunnerResult RestoreSolutionExpectFailure(string workingDirectory, string solutionName, string args = "", Action<string> logLine = null)
            => RestoreProjectOrSolution(workingDirectory, $"{solutionName}.slnx", args, expectSuccess: false, logLine: logLine);

        internal CommandRunnerResult RestoreSolutionExpectSuccess(string workingDirectory, string solutionName, string args = "", Action<string> logLine = null)
            => RestoreProjectOrSolution(workingDirectory, $"{solutionName}.slnx", args, expectSuccess: true, logLine: logLine);

        private CommandRunnerResult RestoreProjectOrSolution(string workingDirectory, string fileName, string args, bool expectSuccess, Action<string> logLine = null)
        ...
        internal CommandRunnerResult RunDotnetExpectSuccess(string workingDirectory, string args = "", IReadOnlyDictionary<string, string> environmentVariables = null, Action<string> logLine = null, Action<StreamWriter> inputAction = null)
        ...
        /// <param name="args">The command-line arguments to pass to dotnet.</param>
        /// <param name="environmentVariables">An optional <see cref="IReadOnlyDictionary{TKey, TValue}" /> containing environment variables to use when executing the command.</param>
        internal CommandRunnerResult RunDotnetExpectFailure(string workingDirectory, string args = "", IReadOnlyDictionary<string, string> environmentVariables = null, Action<string> logLine = null, Action<StreamWriter> inputAction = null)
            => RunDotnet(workingDirectory, args, expectSuccess: false, environmentVariables, logLine, inputAction);

        internal CommandRunnerResult RunDotnet(string workingDirectory, string args = "", bool expectSuccess = true, IReadOnlyDictionary<string, string> environmentVariables = null, Action<string> logLine = null, Action<StreamWriter> inputAction = null)
        {
        ...
        internal CommandRunnerResult PackProjectExpectFailure(string workingDirectory, string projectName, string args = "", string nuspecOutputPath = "obj", string configuration = "Debug", Action<string> logLine = null)
        ...
        internal CommandRunnerResult PackProjectExpectSuccess(string workingDirectory, string projectName, string args = "", string nuspecOutputPath = "obj", string configuration = "Debug", Action<string> logLine = null)
            => PackProjectOrSolution(workingDirectory, $"{projectName}.csproj", args, expectSuccess: true, nuspecOutputPath, configuration, logLine);

        internal CommandRunnerResult PackSolutionExpectFailure(string workingDirectory, string solutionName, string args = "", string nuspecOutputPath = "obj", string configuration = "Debug", Action<string> logLine = null)
            => PackProjectOrSolution(workingDirectory, $"{solutionName}.slnx", args, expectSuccess: false, nuspecOutputPath, configuration, logLine);

        internal CommandRunnerResult PackSolutionExpectSuccess(string workingDirectory, string solutionName, string args = "", string nuspecOutputPath = "obj", string configuration = "Debug", Action<string> logLine = null)
            => PackProjectOrSolution(workingDirectory, $"{solutionName}.slnx", args, expectSuccess: true, nuspecOutputPath, configuration, logLine);

        private CommandRunnerResult PackProjectOrSolution(string workingDirectory, string file, string args, bool expectSuccess, string nuspecOutputPath = "obj", string configuration = "Debug", Action<string> logLine = null)
        {
        ...
        internal void BuildProjectExpectSuccess(string workingDirectory, string projectName, string args = "", bool? appendRidToOutputPath = false, Action<string> logLine = null)
        {
        ...
        internal void BuildSolutionExpectFailure(string workingDirectory, string solutionName, string args = "", bool? appendRidToOutputPath = false, Action<string> logLine = null)
            => BuildProjectOrSolution(workingDirectory, $"{solutionName}.slnx", args, expectSuccess: false, appendRidToOutputPath, logLine);

        internal void BuildSolutionExpectSuccess(string workingDirectory, string solutionName, string args = "", bool? appendRidToOutputPath = false, Action<string> logLine = null)
            => BuildProjectOrSolution(workingDirectory, $"{solutionName}.slnx", args, expectSuccess: true, appendRidToOutputPath, logLine);

        private CommandRunnerResult BuildProjectOrSolution(string workingDirectory, string file, string args, bool expectSuccess = true, bool? appendRidToOutputPath = false, Action<string> logLine = null)
        {
            if (appendRidToOutputPath != null)
            {
                args = $"{args} /p:AppendRuntimeIdentifierToOutputPath={appendRidToOutputPath}";
        ...
        internal (string Content, string ProjectPath, string FilePath) GetFileBasedAppVirtualProject(string entryPointFileFullPath, Action<string> logLine)
        {
