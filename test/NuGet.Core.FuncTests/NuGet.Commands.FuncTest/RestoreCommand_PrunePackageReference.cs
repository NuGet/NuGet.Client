    ...
    public class RestoreCommand_PrunePackageReference
    {
            ...
            var rootProject = @"
        {
          ""frameworks"": {
            ...
            result.LockFile.Targets[0].Libraries[2].CompileTimeAssemblies.Should().BeEmpty();
            result.LockFile.Targets[0].Libraries[2].RuntimeAssemblies.Should().BeEmpty();
            ...
            result.LockFile.Targets[0].Libraries[2].RuntimeTargets.Should().BeEmpty();
