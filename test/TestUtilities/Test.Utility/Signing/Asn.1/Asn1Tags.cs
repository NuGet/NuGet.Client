...
namespace Test.Utility.Signing
{
    ...
    {
        internal static readonly Asn1Tag ContextSpecific0 = new(TagClass.ContextSpecific, tagValue: 0);
        internal static readonly Asn1Tag ContextSpecific1 = new(TagClass.ContextSpecific, tagValue: 1);
