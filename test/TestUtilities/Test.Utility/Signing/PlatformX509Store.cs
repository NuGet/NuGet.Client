...
namespace Test.Utility.Signing
{
    internal sealed class PlatformX509Store : IX509Store, IRootX509Store
    {
        ...
        public void Remove(X509Certificate2 certificate, StoreLocation storeLocation, StoreName storeName)
        {
            if ((RuntimeEnvironmentHelper.IsMacOSX && storeName.Equals(StoreName.My) && storeLocation.Equals(StoreLocation.CurrentUser))
                || !RuntimeEnvironmentHelper.IsMacOSX)
            {
        ...
        public void Add(X509Certificate2 certificate, StoreLocation storeLocation)
        {
            Add(certificate, storeLocation, StoreName.Root);
        }

        public void Remove(X509Certificate2 certificate, StoreLocation storeLocation)
        {
            Remove(certificate, storeLocation, StoreName.Root);
        }
