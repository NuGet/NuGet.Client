        ...
        public void ListCommand_AllVersions()
        {
            ...
            using (var randomTestFolder = TestDirectory.Create())
            {
                ...
                using (var server = new MockServer())
                {
                    ...
                    // verify that the output is detailed
                    var expectedOutput = "testPackage1 1.1.0" + Environment.NewLine + "testPackage1 1.0.5" + Environment.NewLine +
                        "testPackage2 2.1.0" + Environment.NewLine + "testPackage2 2.0.0" + Environment.NewLine;
                    Assert.Equal(expectedOutput, r1.Item2);
