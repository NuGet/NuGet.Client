...
//</configuration>");
        ...
        public static IEnumerable<object[]> GetWebSiteTemplates()
        {
            ...
            yield return new object[] { ProjectTemplate.WebSiteReportApplication, "WebSiteApp", ProjectTargetFramework.V48, "Log4Net.Async", "2.0.3" };
            ...
            yield return new object[] { ProjectTemplate.WebSiteDynamicDataLinqToSql, "WebSiteLinq", ProjectTargetFramework.V48, "Log4Net.Async", "2.0.3" };
        }
        ...
        public static IEnumerable<object[]> UpdateWebSiteTemplates()
        {
            ...
            yield return new object[] { ProjectTemplate.WebSiteReportApplication, "WebSiteApp", ProjectTargetFramework.V48, "Log4Net.Async", "2.0.3", "2.0.4" };
            ...
            yield return new object[] { ProjectTemplate.WebSiteDynamicDataLinqToSql, "WebSiteLinq", ProjectTargetFramework.V48, "Log4Net.Async", "2.0.3", "2.0.4" };
        }

        [NuGetWpfTheory]
        [MemberData(nameof(UninstallWebSiteTemplates))]
        public void UninstallPackageFromWebSiteFromUI(ProjectTemplate projectTemplate, string projectName, ProjectTargetFramework targetFramework, string packageName, string packageVersion)
        {
            // Arrange
            EnsureVisualStudioHost();
            var dte = VisualStudio.Dte;
        ...
        public static IEnumerable<object[]> UninstallWebSiteTemplates()
        {
            ...
            yield return new object[] { ProjectTemplate.WebSiteReportApplication, "WebSiteApp", ProjectTargetFramework.V48, "Log4Net.Async", "2.0.4" };
            ...
            yield return new object[] { ProjectTemplate.WebSiteDynamicDataLinqToSql, "WebSiteLinq", ProjectTargetFramework.V48, "Log4Net.Async", "2.0.4" };
        }
    }
}
