...
namespace NuGet.Client
{
    ...
    public static class RepositoryFactory
    {
        ...
        private static IEnumerable<Lazy<INuGetResourceProvider>> _providers;
        ...
        public static SourceRepository CreateV2(PackageSource source)
        {
            ...
            return new SourceRepository(source, _providers.Where(e => e.Value.Name.StartsWith("V2", StringComparison.OrdinalIgnoreCase)));
        }
        ...
        public static SourceRepository CreateV3(PackageSource source)
        {
            ...
            return new SourceRepository(source, _providers.Where(e => e.Value.Name.StartsWith("V3", StringComparison.OrdinalIgnoreCase)));
        }
            ...
            if (_providers == null)
            {
                try
                {
                    ...
                    using (var catalog = new AggregateCatalog(new DirectoryCatalog(path, "NuGet.*.dll")))
                    {
                        ...
                        _providers = container.GetExports<INuGetResourceProvider>();
