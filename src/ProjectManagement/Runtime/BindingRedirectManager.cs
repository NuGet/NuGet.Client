...
namespace NuGet.ProjectManagement.Runtime
{
    ...
    public class BindingRedirectManager
    {
        ...
        public BindingRedirectManager(string root, string configurationPath)
        {
            ...
            {
                throw new ArgumentException(Strings.Argument_Cannot_Be_Null_Or_Empty, "root");
            }
            if (String.IsNullOrEmpty(configurationPath))
            {
                throw new ArgumentException(Strings.Argument_Cannot_Be_Null_Or_Empty, "configurationPath");
            }
