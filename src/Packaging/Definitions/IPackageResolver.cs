...
namespace NuGet.Packaging
{
    ...
    public interface IPackageResolver
    {
        ...
        IEnumerable<PackageIdentity> Resolve(IEnumerable<PackageIdentity> targets, IEnumerable<PackageDependencyInfo> availablePackages);
        ...
        /// <returns>A set of packages meeting the package dependency requirements</returns>
        IEnumerable<PackageIdentity> Resolve(IEnumerable<PackageIdentity> targets, IEnumerable<PackageDependencyInfo> availablePackages, IEnumerable<PackageReference> installedPackages);
    }
}
