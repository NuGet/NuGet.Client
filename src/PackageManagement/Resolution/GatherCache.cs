...
namespace NuGet.PackageManagement
{
    ...
    internal class GatherCache
    {
        ...
        /// </summary>
        public void AddPackageFromSingleVersionLookup(PackageSource source, PackageIdentity identity, SourcePackageDependencyInfo package)
        {
        ...
        /// </summary>
        public void AddAllPackagesForId(PackageSource source, string packageId, List<SourcePackageDependencyInfo> packages)
        {
        ...
        /// </summary>
        public GatherCacheResult GetPackage(PackageSource source, PackageIdentity package)
        {
        ...
        /// </summary>
        public GatherCacheResult GetPackages(PackageSource source, string packageId)
        {
            var key = new SourceAndPackageId(packageId, source);
        ...
        {
            public SourceAndPackageIdentity(PackageIdentity package, PackageSource source)
            {
                Package = package;
                Source = source;
            }
        ...
        {
            public SourceAndPackageId(string packageId, PackageSource source)
            {
                PackageId = packageId;
                Source = source;
            }
