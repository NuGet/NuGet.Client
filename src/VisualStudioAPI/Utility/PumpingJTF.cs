...
namespace NuGet.VisualStudio
{
    ...
    /// This class is used to have a pumping JTF, in order, to not allow access to DTE objects from a background thread
    ...
    {
        public PumpingJTF(JoinableTaskContext joinableTaskContext) : base(joinableTaskContext)
        {
        }
