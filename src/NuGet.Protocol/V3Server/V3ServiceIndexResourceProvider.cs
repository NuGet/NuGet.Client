...
namespace NuGet.Protocol
{
    ...
    public class V3ServiceIndexResourceProvider : ResourceProvider
    {
        private readonly ConcurrentDictionary<string, V3ServiceIndexResource> _cache;

        public V3ServiceIndexResourceProvider()
            : base(typeof(V3ServiceIndexResource), "V3ServiceIndexResourceProvider", NuGetResourceProviderPositions.Last)
        {
