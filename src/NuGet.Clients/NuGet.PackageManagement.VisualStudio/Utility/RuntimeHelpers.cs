    ...
    public static class RuntimeHelpers
    {
        ...
        private static async Task<bool> SupportsBindingRedirectsAsync(EnvDTE.Project Project)
        {
            return (Project.Kind != null && SupportedProjectTypes.IsSupportedForBindingRedirects(Project.Kind))
                && !await EnvDTEProjectInfoUtility.IsWindowsStoreAppAsync(Project);
        }
            ...
            INuGetProjectContext nuGetProjectContext)
        {
            ...
            var manager = new BindingRedirectManager(await EnvDTEProjectInfoUtility.GetConfigurationFileAsync(vsProjectAdapter.Project), msBuildNuGetProjectSystem);
