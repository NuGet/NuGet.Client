...
namespace NuGetConsole.Host.PowerShell.Implementation
{
    internal abstract class PowerShellHost : IHost, IPathExpansion, IDisposable
    {
        ...
        private readonly Lazy<PowerShellHostTelemetryProcessor> _vsPowerShellHostTelemetryEmit;
        ...
        protected PowerShellHost(string name, IRestoreEvents restoreEvents, IRunspaceManager runspaceManager)
        {
            ...
            _vsPowerShellHostTelemetryEmit = new Lazy<PowerShellHostTelemetryProcessor>(() => ServiceLocator.GetInstanceSafe<PowerShellHostTelemetryProcessor>());
            _name = name;
                ...
                else
                {
                    try
                    {
                        ...
                        _solutionManager.Value.SolutionClosing += (o, e) =>
                        {
                            ...
                            _vsPowerShellHostTelemetryEmit.Value.HandleSolutionClosingEmit();
                        };
            ...
            try
            {
                ...
                if (Directory.Exists(toolsPath))
                {
                    ...
                    if (File.Exists(scriptPath))
                    {
                        ...
                        _vsPowerShellHostTelemetryEmit.Value.RecordInitPs1loaded(_activeConsole is IWpfConsole);
