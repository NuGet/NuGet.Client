...
namespace NuGet.PackageManagement.PowerShellCmdlets {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The &apos;{0}&apos; parameter is not respected for the &apos;PackageReference&apos; based project(s) {1}. The enabled sources in your NuGet configuration will be used. .
        /// </summary>
        internal static string Warning_SourceNotRespectedForProjectStyle {
            get {
                return ResourceManager.GetString("Warning_SourceNotRespectedForProjectStyle", resourceCulture);
            }
        }
    }
}
