...
namespace NuGetVSExtension
{
    ...
    [ProvideBrokeredService(BrokeredServicesUtilities.RemoteFileServiceName, BrokeredServicesUtilities.RemoteFileServiceVersion, Audience = ServiceAudience.Local | ServiceAudience.RemoteExclusiveClient)]
