...
namespace NuGetVSExtension
{
    ...
    [ProvideBrokeredService(BrokeredServicesUtilities.SourceProviderServiceName, BrokeredServicesUtilities.SourceProviderServiceVersion_1_0_1, Audience = ServiceAudience.AllClientsIncludingGuests)]
