...
namespace NuGet.PackageManagement.UI
{
    ...
    /// </summary>
    public partial class PackageMetadataDescriptionControl : UserControl
    {
        public PackageMetadataDescriptionControl()
        {
            InitializeComponent();

            Visibility = Visibility.Collapsed;
            DataContextChanged += PackageMetadataDescriptionControl_DataContextChanged;
        }
        ...
        private void PackageMetadataDescriptionControl_DataContextChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
