...
namespace NuGet.VisualStudio.Internal.Contracts
{
    public static class NuGetServices
    {
        ...
        public static readonly ServiceRpcDescriptor RemoteFileService = new NuGetServiceMessagePackRpcDescriptor(
          new ServiceMoniker(RemoteFileServiceName, new Version(RemoteFileServiceVersion)));
