...
namespace NuGet.PackageManagement.VisualStudio
{
    ...
    {
        public Dictionary<string, DependencyGraphProjectCacheEntry> DependencyGraphProjectCache { get; set; } = new Dictionary<string, DependencyGraphProjectCacheEntry>(StringComparer.Ordinal);
