...
namespace Microsoft.Build.NuGetSdkResolver
{
    ...
    internal sealed class GlobalJsonReader : IGlobalJsonReader
    {
        ...
        private Dictionary<string, string> ParseMSBuildSdkVersions(string globalJsonPath, SdkResolverContext sdkResolverContext)
        {
            ...
            NuGetSdkResolverEventSource.Instance.GlobalJsonReadStart(globalJsonPath, sdkResolverContext.ProjectFilePath, sdkResolverContext.SolutionFilePath);
            ...
            {
                NuGetSdkResolverEventSource.Instance.GlobalJsonReadStop(globalJsonPath, sdkResolverContext.ProjectFilePath, sdkResolverContext.SolutionFilePath);
            }
        }
    }
}
