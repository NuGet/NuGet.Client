...
namespace NuGet.Common.Migrations
{
    public static class MigrationRunner
    {
        ...
        internal static void Run(IEnvironmentVariableReader environmentVariableReader)
        {
            ...
            Run(environmentVariableReader, migrationsDirectory);
        }

        internal static void Run(IEnvironmentVariableReader environmentVariableReader, string migrationsDirectory)
        {
