...
namespace NuGet.Common
{
    public static class CryptoHashUtility
    {
        ...
        [Obsolete("Call GetHashAlgorithm Instead. GetSha1HashProvider method exists to compute SHA1 hash of entire certificate for comparison with EssCertId.CertificateHash property")]
