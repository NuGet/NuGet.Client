...
namespace NuGet.Configuration
{
    ...
    public class PackageSourceMappingSourceItem : SettingItem
    {
        ...
        protected override IReadOnlyCollection<string> RequiredAttributes { get; } = new HashSet<string>(new[] { ConfigurationConstants.KeyAttribute }, StringComparer.Ordinal);
