    ...
    public static class PushRunner
    {
            ...
            ILogger logger)
        {
            ...
            await packageUpdateResource.Push(
                ...
                timeoutSeconds,
                disableBuffering,
                endpoint => apiKey ?? CommandRunnerUtility.GetApiKey(settings, endpoint, source, defaultApiKey: null),
                symbolsEndpoint => symbolApiKey ?? CommandRunnerUtility.GetApiKey(settings, symbolsEndpoint, symbolSource, apiKey),
                noServiceEndpoint,
                skipDuplicate,
