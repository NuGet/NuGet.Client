...
#pragma warning disable CA1031 // Do not catch general exception types
                    ...
                    {
                        IRestoreLogMessage restoreLogMessage = new RestoreLogMessage(LogLevel.Error, ex.Message);
                        RestoreSummary restoreSummary = new RestoreSummary(success: false, errors: new List<IRestoreLogMessage>() { restoreLogMessage });
                    }
