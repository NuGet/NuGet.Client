...
namespace NuGet.CommandLine.XPlat {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The command option &apos;--exclude-project&apos; is ignored by this command..
        /// </summary>
        internal static string ListPkg_DefaultIgnoredOptions {
            get {
                return ResourceManager.GetString("ListPkg_DefaultIgnoredOptions", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Exclude projects from transitive packages in the result..
        /// </summary>
        internal static string ListPkg_ExcludeProjectDescription {
            get {
                return ResourceManager.GetString("ListPkg_ExcludeProjectDescription", resourceCulture);
            }
        }
