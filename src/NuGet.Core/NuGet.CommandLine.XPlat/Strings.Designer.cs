...
namespace NuGet.CommandLine.XPlat {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Error while loading project(s)..
        /// </summary>
        internal static string Error_UnableToLoadProjects {
            get {
                return ResourceManager.GetString("Error_UnableToLoadProjects", resourceCulture);
            }
        }
