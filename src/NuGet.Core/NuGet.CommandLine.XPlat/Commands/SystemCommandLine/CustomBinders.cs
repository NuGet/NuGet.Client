...
namespace NuGet.CommandLine.XPlat.Commands
{
    ...
    internal partial class AddSourceCustomBinder
    {
    ...
    //    public AddSourceCustomBinder(CliArgument<string> source, CliOption<string> name,
    //        CliOption<string> username,
    //        CliOption<string> password, CliOption<bool> storePasswordInClearText, CliOption<string> validAuthenticationTypes, CliOption<string> configfile)
    //    {
    //        _source = source;
    //        _name = name;
    //        _username = username;
