...
namespace NuGet.Protocol.Plugins
{
    ...
    public sealed class Connection : IConnection
    {
        ...
        public async Task SendAsync(Message message, CancellationToken cancellationToken)
        {
            ...
            {
                _logger.Write(new CommunicationsLogMessage(_logger.Now, message.RequestId, message.Method, message.Type, MessageState.Sending));
            }
            ...
            if (_logger.IsEnabled)
            {
                _logger.Write(new CommunicationsLogMessage(_logger.Now, message.RequestId, message.Method, message.Type, MessageState.Sent));
            }
        }
        ...
        private void OnMessageReceived(object sender, MessageEventArgs e)
        {
            if (_logger.IsEnabled)
            {
                _logger.Write(new CommunicationsLogMessage(_logger.Now, e.Message.RequestId, e.Message.Method, e.Message.Type, MessageState.Received));
            }
