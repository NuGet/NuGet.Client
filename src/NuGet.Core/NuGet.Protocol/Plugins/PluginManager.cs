...
namespace NuGet.Protocol.Plugins
{
    ...
    public sealed class PluginManager : IPluginManager, IDisposable
    {
        static PluginManager()
        {
            ...
            NuGet.Common.StaticState.EndMSBuildRestoreTasks += ResetSharedInstance;
        }
        ...
        /// <see cref="NuGet.Common.StaticState.EndMSBuildRestoreTasks" /> and invoked by restore at the end of a
