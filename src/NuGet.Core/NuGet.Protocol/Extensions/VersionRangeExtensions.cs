...
namespace NuGet.Protocol.Extensions
{
    ...
    {
        public static bool CheckIfVersionRangeRequiredRegistrationPage(this VersionRange dependencyRange, NuGetVersion catalogItemLower, NuGetVersion catalogItemUpper)
        {
