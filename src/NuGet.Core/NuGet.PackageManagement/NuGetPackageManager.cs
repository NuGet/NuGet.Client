    ...
    public class NuGetPackageManager
    {
        ...
        private Task OpenReadmeFile(NuGetProject nuGetProject, INuGetProjectContext nuGetProjectContext, CancellationToken token)
        {
                ...
                && executionContext.DirectInstall != null)
            {
                ...
                if (buildIntegratedProject != null)
                {
                    var packageFolderPath = BuildIntegratedProjectUtility.GetPackagePathFromGlobalSource(Configuration.SettingsUtility.GetGlobalPackagesFolder(Settings), nuGetProjectContext.ExecutionContext.DirectInstall);
                    if (Directory.Exists(packageFolderPath))
                    {
