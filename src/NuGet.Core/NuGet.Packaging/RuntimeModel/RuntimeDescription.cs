...
namespace NuGet.RuntimeModel
{
    ...
    {
        private static readonly IReadOnlyDictionary<string, RuntimeDependencySet> EmptyRuntimeDependencySets = new Dictionary<string, RuntimeDependencySet>(StringComparer.Ordinal);
