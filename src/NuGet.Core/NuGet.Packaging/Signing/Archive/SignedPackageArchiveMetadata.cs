...
namespace NuGet.Packaging.Signing
{
    ...
    public sealed class SignedPackageArchiveMetadata
    {
        ...
        /// </summary>
        public required int SignatureCentralDirectoryHeaderIndex { get; set; }
