...
namespace NuGet.Packaging.PackageCreation.Resources {
    ...
    public class NuGetResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Cannot create package with a token &apos;{0}&apos;..
        /// </summary>
        public static string InvalidWithToken {
            get {
                return ResourceManager.GetString("InvalidWithToken", resourceCulture);
            }
        }
