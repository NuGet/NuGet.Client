...
namespace NuGet.Packaging.PackageCreation.Resources {
    ...
    public class NuGetResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Fatal exception while reading manifest property &apos;{0}&apos;. If using replacement tokens, ensure you are targeting the corresponding project file..
        /// </summary>
        public static string Manifest_PropertyValueReadFailure {
            get {
