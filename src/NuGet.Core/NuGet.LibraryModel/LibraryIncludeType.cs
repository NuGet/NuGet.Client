...
namespace NuGet.LibraryModel
{
    public class LibraryIncludeType : IEquatable<LibraryIncludeType>
    {
        ...
        public static readonly LibraryIncludeType Default = new LibraryIncludeType(LibraryIncludeTypeKeyword.Default.FlagsToAdd);
        public static readonly LibraryIncludeType All = new LibraryIncludeType(LibraryIncludeTypeKeyword.All.FlagsToAdd);
