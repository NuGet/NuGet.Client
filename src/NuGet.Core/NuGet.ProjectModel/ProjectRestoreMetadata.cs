...
namespace NuGet.ProjectModel
{
    public class ProjectRestoreMetadata : IEquatable<ProjectRestoreMetadata>
    {
        ...
        public bool PrivateAssetIndependent { get; set; }
        ...
        public override int GetHashCode()
        {
            ...
            hashCode.AddObject(PrivateAssetIndependent);
        ...
        public bool Equals(ProjectRestoreMetadata other)
        {
            ...
            return ProjectStyle == other.ProjectStyle &&
                   ...
                   EqualityUtility.EqualsWithNullCheck(PrivateAssetIndependent, other.PrivateAssetIndependent);
        }
        ...
        protected void FillClone(ProjectRestoreMetadata clone)
        {
            ...
            clone.PrivateAssetIndependent = PrivateAssetIndependent;
        }
    }
}
