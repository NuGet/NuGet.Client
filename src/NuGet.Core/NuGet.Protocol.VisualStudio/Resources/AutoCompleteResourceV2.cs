...
{
    public class AutoCompleteResourceV2 : AutoCompleteResource
    {
        private readonly IPackageRepository V2Client;

        public AutoCompleteResourceV2(V2Resource resource)
        {
            V2Client = resource.V2Client;
        }

        public AutoCompleteResourceV2(IPackageRepository repo)
        {
            V2Client = repo;
        }
