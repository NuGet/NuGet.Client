            ...
            return new[]
                {
                    ...
                    // new OneWayCompatibilityMappingEntry(new FrameworkRange(
                    //         new NuGetFramework(FrameworkConstants.FrameworkIdentifiers.NetCoreApp, new Version(6, 0, 0, 0), "android", FrameworkConstants.EmptyVersion),
                    //         new NuGetFramework(FrameworkConstants.FrameworkIdentifiers.NetCoreApp, FrameworkConstants.MaxVersion, "android", FrameworkConstants.MaxVersion)),
                    //     new FrameworkRange(
                    //         new NuGetFramework(FrameworkConstants.FrameworkIdentifiers.MonoAndroid),
                    //         new NuGetFramework(FrameworkConstants.FrameworkIdentifiers.MonoAndroid, FrameworkConstants.MaxVersion))),
                    // new OneWayCompatibilityMappingEntry(new FrameworkRange(
                    //         new NuGetFramework(FrameworkConstants.FrameworkIdentifiers.NetCoreApp, new Version(6, 0, 0, 0), "tizen", FrameworkConstants.EmptyVersion),
                    //         new NuGetFramework(FrameworkConstants.FrameworkIdentifiers.NetCoreApp, FrameworkConstants.MaxVersion, "tizen", FrameworkConstants.MaxVersion)),
                    //     new FrameworkRange(
                    //         new NuGetFramework(FrameworkConstants.FrameworkIdentifiers.Tizen),
                    //         new NuGetFramework(FrameworkConstants.FrameworkIdentifiers.Tizen, FrameworkConstants.MaxVersion))),
                }
                .Concat(new[]
                {
